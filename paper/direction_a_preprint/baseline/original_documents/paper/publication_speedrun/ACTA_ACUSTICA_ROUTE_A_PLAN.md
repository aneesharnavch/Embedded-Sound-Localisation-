...
**Current status:** the direction and plan are selected; the proposed experiments have not been executed. Existing draft results remain historical results of their documented implementation. The supporting journal review and scientific audit are available in the [earlier publication plan](/home/ani/Desktop/sound_local/paper/publication_speedrun/PUBLICATION_SPEEDRUN_PLAN.md), [scientific audit](/home/ani/Desktop/sound_local/paper/publication_speedrun/SCIENTIFIC_AUDIT.md), and [reading register](/home/ani/Desktop/sound_local/paper/publication_speedrun/READING_REGISTER.html).
