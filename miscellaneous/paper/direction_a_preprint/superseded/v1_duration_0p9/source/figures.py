...
def run():
    ...
    names=['Propagation','Image coverage','GCC sampling','SRP grid'];keys=['propagation32','extent56','correlation16','srp_grid005']
    ...
    axes[1].set(xscale='log',xlabel='Averaging duration (s)',ylabel='RMSE (deg)',title='(b) 48 scenes passing training rule');axes[1].legend();axes[1].grid()
    ...
    for room,ax in enumerate(axes):
        ...
        im=ax.imshow(a,aspect='auto',cmap='viridis',vmin=0,vmax=85)
