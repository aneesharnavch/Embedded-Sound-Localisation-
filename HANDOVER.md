...
> **Repository cleanup — 9 September 2026:** original recordings, code, current papers, and both scientific campaigns are retained. Duplicate imports, virtual environments, response caches, downloaded literature, generated release copies, and temporary renders were removed. The three unique older documents from the full-project snapshot are retained under [baseline/original_documents](paper/direction_a_preprint/baseline/README.md). See [README.md](README.md) for the current layout and [release instructions](paper/direction_a_preprint/release/README.md) to regenerate the source/data ZIP. Earlier references below to the removed archive, template ZIP, or local tools are historical; the template sources remain in `author/`.

> **Latest editorial preview — 8 September 2026:** the author requested the actual Acta Acustica template and plainer, more explanatory prose guided by the initial Journal of Open Hardware draft. A complete ten-page preview is available at [main_acta.pdf](/home/ani/Desktop/sound_local/paper/direction_a_preprint/acta_preview/main_acta.pdf). It uses the supplied EDP Sciences class and preserves the verified results, figures and bibliography. All final pages have been inspected. The original paper, supplement and source/data archive remain intact; the preview awaits the author’s style review.

> **Current direction — 8 September 2026:** **Direction A, preprint first**, using Acta Acustica's scientific structure and presentation. The local author-review package is complete: [review brief](/home/ani/Desktop/sound_local/paper/direction_a_preprint/AUTHOR_REVIEW.md), [execution checklist](/home/ani/Desktop/sound_local/paper/publication_speedrun/DIRECTION_A_PREPRINT_TODO.md), and `paper/direction_a_preprint/progress.json`. A01–A35 are complete; A36–A37 are deferred because the author requested a server-neutral package. The nine-page paper and five-page supplement use only the corrected v2 results: 276,480 primary estimates, all audited. Clean reproduction matched 8,640 representative estimates exactly and all six main figures byte for byte. A stronger joint duration/image test invalidated the initial 0.9-second run; it is preserved under `superseded/v1_duration_0p9`. The complete final 1.2-second/extent76/P32 study and refinements pass. Author: Aneesh Arnav Chikkala; no affiliation; self-funded. Conflict declaration, final scientific review, licenses and public release remain pending. Nothing has been uploaded. The historical thesis and journal-policy claims below are superseded by the current paper and review brief.
