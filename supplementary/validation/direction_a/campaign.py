...
def run_scene(job,output=None):
    ...
    with gzip.open(temp,'wt',newline='') as f:
        ...
        for snr,record_id in product((0.,10.,20.),range(5)):
            record=inputs(cfg,d,32,record_id,snr,'main_v2');remember(record,record_id,snr,'core',32)
        ...
        if is_subset:
            for record_id in range(10):
                ...
                record=inputs(cfg,d,128,record_id,10.,'long_v2');remember(record,record_id,10.,experiment,128)
